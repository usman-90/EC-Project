...
import MultipleSelectListProps from '../MultiListProps';
...
const MultipleSelectList: React.FC<MultipleSelectListProps> = ({
    ...
    const [selectedval, setSelectedVal] = React.useState<any>(selected.map(item => item.name));
    ...
    // useEffect(() => {
    //   console.log("selected items inside multiselect", selectedval);
    // }, [selectedval]);
