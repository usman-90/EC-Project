...
export default function Home() {
    ...
    return (
        <StyledScrollView className='flex-1 bg-white' ref={animatedRef} onScroll={scrollHandler}>
            ...
            <StyledView className='h-72' >
                ...
                <StyledView className='flex flex-row relative sm:bottom-24 md:bottom-24 h-0' >
                    <StyledView className='flex-[.45] flex-col items-center relative' >
                        <StyledImage source={logo} className={`sm:w-[155px] sm:h-[33px] absolute sm:left-4 md:left-5 sm:top-5`} />
                        <StyledView className='absolute flex-row sm:left-4 md:left-5 sm:top-24 rounded-full' style={{backgroundColor:'#FFF5D3'}}>
                            <StyledButton title='Buy' onPress={openListing} className='p-1 m-2 w-16 md:p-1 md:m-2 md:w-16 bg-[#FFD549] rounded-full' ><Text className='text-center font-bold'>Rent</Text></StyledButton>
                            <StyledButton title='Rent' className='p-1 my-2 w-12 md:p-1 md:my-2 md:mr-2 md:w-12 rounded-full' ><Text className='text-gray-500 font-bold'>Buy</Text></StyledButton>
                        </StyledView>
                    </StyledView>
                    <StyledView className='flex-[.65] items-center relative'>
                        <AnimatedImage source={buildingIcon} className={'sm:w-[203px] sm:h-[188px]'} style={{opacity:opacity1}} />
                    </StyledView>
                </StyledView>
