...
const CreatePassword = ({navigation}) => {
  ...
  // Check if the password contains at least one uppercase letter
    ...
    console.log("Rules cleared", isLengthValid, hasUpperCase, hasLowerCase, hasNumber, hasSpecialChar);
    ...
    <>
      <View className="italic" style={styles.container}>
        ...
        <View className="flex flex-row items-center gap-2 my-4 px-6">
          <Icon name="check-circle" size={20} color={pwHasStrongChar ? 'green' : 'black'} />
        ...
        <View className="flex flex-row items-center gap-2 w-full text-sm px-6">
          <Icon name="check-circle" size={20} color={pwHasSpecialChar ? 'green' : 'black'} />
