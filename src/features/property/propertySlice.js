  ...
  initialState: {
    data: {
      ...
      propertyDetails: {
        refNo: "89789",
        title: "IceCream Load",
        titleArabic: "Manshiaat",
        description: "Alpharado pato cheeni or gaddi lambogini",
        descriptionArabic: "Alpharado pato cheeni or gaddi lambogini",
        areaSquare: 1000,
        InclusivePrice: 1200,
        PermitNumber: 2,
      ...
      contactDetails: {
        ListingOwner: "Bilal",
        contactPerson: "Bilal",
        email: "bilal.khan@macworldtechnology.com",
        phone: "+923160111354",
      },
      amenities: [
        {
